  ...
  <div class="bg-gray-50 py-16 sm:py-24">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        <h2 class="text-base font-semibold text-green-700 tracking-wide uppercase">Cadre d'Utilisation</h2>
      ...
      <div class="bg-white p-8 sm:p-12 rounded-lg shadow-md text-base leading-7 text-gray-700">
        <!-- Sommaire -->
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">Sommaire</h2>
        <nav class="mb-12">
          <ul class="space-y-2">
            <li><a href="#I" class="text-green-700 hover:text-green-800">1. Introduction</a></li>
            <li><a href="#II" class="text-green-700 hover:text-green-800">2. Acceptation des CGU</a></li>
            <li><a href="#III" class="text-green-700 hover:text-green-800">3. Présentation du site</a></li>
            <li><a href="#IV" class="text-green-700 hover:text-green-800">4. Description des Services</a></li>
            <li><a href="#V" class="text-green-700 hover:text-green-800">5. Limitations contractuelles sur les données techniques</a></li>
            <li><a href="#VI" class="text-green-700 hover:text-green-800">6. Propriété intellectuelle et contrefaçons</a></li>
            <li><a href="#VII" class="text-green-700 hover:text-green-800">7. Limitations de responsabilité</a></li>
            <li><a href="#VIII" class="text-green-700 hover:text-green-800">8. Gestion des données personnelles</a></li>
            <li><a href="#IX" class="text-green-700 hover:text-green-800">9. Liens hypertextes et cookies</a></li>
            <li><a href="#X" class="text-green-700 hover:text-green-800">10. Droit applicable et attribution de juridiction</a></li>
            <li><a href="#XI" class="text-green-700 hover:text-green-800">11. Lexique</a></li>
          </ul>
        </nav>

        <!-- Introduction -->
        <section id="I" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">1. Introduction</h2>
          <p class="mb-4">
        ...
        <section id="II" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">2. Acceptation des CGU</h2>
          <p>
        ...
        <section id="III" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">3. Présentation du site</h2>
          <p class="mb-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div class="p-4 bg-gray-50 rounded-lg">
              <h3 class="font-semibold text-lg mb-2">Propriétaire</h3>
              <p>
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
              <h3 class="font-semibold text-lg mb-2">Hébergeur</h3>
              <p>
                <strong>
                  <a href="https://www.hostinger.com/" class="text-green-700 hover:text-green-800 underline">
            ...
            <div class="p-4 bg-gray-50 rounded-lg">
              <h3 class="font-semibold text-lg mb-2">Webmaster</h3>
              <p>
                <strong>Anthony MUDET</strong><br>
                <a href="mailto:admin@naurellia.com" class="text-green-700 hover:text-green-800 underline">admin@naurellia.com</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="IV" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">4. Description des Services</h2>
          <p class="mb-4">
        ...
        <section id="V" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">5. Limitations contractuelles sur les données techniques</h2>
          <p class="mb-4">
        ...
        <section id="VI" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">6. Propriété intellectuelle et contrefaçons</h2>
          <p class="mb-4">
        ...
        <section id="VII" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">7. Limitations de responsabilité</h2>
          <p class="mb-4">
        ...
        <section id="VIII" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">8. Gestion des données personnelles</h2>
          <p class="mb-4">
        ...
        <section id="IX" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">9. Liens hypertextes et cookies</h2>
          <p class="mb-4">
        ...
        <section id="X" class="mb-12">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">10. Droit applicable et attribution de juridiction</h2>
          <p class="mb-4">
        ...
        <section id="XI">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900 border-b border-gray-200 pb-3 mb-6">11. Lexique</h2>
          <p>
